...
def padding_336(b):
    ...
    bottom_padding = int(tar - height - top_padding)
    left_padding = 0
    right_padding = 0
...
class Phi3VImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        self,
        images: ImageInput,
        global_images: Optional[ImageInput] = None,
        image_mean: Optional[Union[float, List[float]]] = None,
        image_std: Optional[Union[float, List[float]]] = None,
        do_convert_rgb: bool = None,
        return_tensors: Optional[Union[str, TensorType]] = None,
        img_processor: Optional[callable] = None,
    ):
        """
        Args:
            images (`ImageInput`):
        ...
        if global_images is not None:
            global_images = make_list_of_images(global_images)
            global_image = []
            for im in global_images:
                im = img_processor(im)
